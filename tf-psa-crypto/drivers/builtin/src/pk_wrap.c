...
#else /* PSA_HAVE_ALG_EDDSA_VERIFY */
    .verify_func = NULL,
#endif /* PSA_HAVE_ALG_EDDSA_VERIFY */
#if defined(PSA_HAVE_ALG_EDDSA_SIGN)
    .sign_func = eddsa_sign_wrap,   /* Compatible key structures */
#else /* PSA_HAVE_ALG_EDDSA_SIGN */
    .sign_func = NULL,
#endif /* PSA_HAVE_ALG_EDDSA_SIGN */
#if defined(MBEDTLS_EDDSA_C) && defined(MBEDTLS_ECP_RESTARTABLE)
    .verify_rs_func = NULL,
    .sign_rs_func = NULL,
    .rs_alloc_func = NULL,
    .rs_free_func = NULL,
#endif /* MBEDTLS_EDDSA_C && MBEDTLS_ECP_RESTARTABLE */
    .decrypt_func = NULL,
    .encrypt_func = NULL,
    .check_pair_func = eckey_check_pair_wrap,   /* Compatible key structures */
#if defined(MBEDTLS_PK_USE_PSA_EC_DATA)
