...
#define PSA_HAVE_ALG_SOME_EDDSA
#endif

#if defined(PSA_HAVE_ALG_SOME_EDDSA) && defined(PSA_WANT_KEY_TYPE_ECC_KEY_PAIR_BASIC)
#define PSA_HAVE_ALG_EDDSA_SIGN
#endif

#if defined(PSA_HAVE_ALG_SOME_EDDSA) && defined(PSA_WANT_KEY_TYPE_ECC_PUBLIC_KEY)
#define PSA_HAVE_ALG_EDDSA_VERIFY
#endif
