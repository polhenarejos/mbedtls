...
#if defined(PSA_WANT_ALG_EDDSA_ANY) && !defined(PSA_WANT_ALG_EDDSA)
#define PSA_WANT_ALG_EDDSA PSA_WANT_ALG_EDDSA_ANY
#elif !defined(PSA_WANT_ALG_EDDSA_ANY) && defined(PSA_WANT_ALG_EDDSA)
#define PSA_WANT_ALG_EDDSA_ANY PSA_WANT_ALG_EDDSA
#endif
